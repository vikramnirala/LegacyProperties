...
function ViewModel() {
  ...
  self.OccupiedBy = ko.observable('');
  self.tenantPlacement = ko.observableArray([]);
  self.propertyShowing = ko.observableArray([]);
  self.advertising = ko.observableArray([]);
  self.screening = ko.observableArray([]);
  self.inspection = ko.observableArray([]);
  self.inspectionChecked = ko.observable('');
  self.maintenance = ko.observableArray([]);
  self.collection = ko.observableArray([]);
  self.HOA = ko.observableArray([]);
