...
Route::get('/new-client-application', 'User\UserDataController@newClientApplication');  
Route::post('/new-client-application-submit', 'User\UserDataController@newClientApplicationSubmit');  
Route::get('/account-settings', 'User\UserDataController@accountSettings');
Route::get('/profile', 'ProfileController@show');
Route::post('/profile/update', 'ProfileController@update')->name('profile.update');
Route::post('/profile/updatePassword', 'ProfileController@update')->name('password.update');
